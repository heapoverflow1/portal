...
public class Jatek {
	...
	public static void main(String[] args) throws Throwable{
	    ...
	    //Egyel�re a p�ly�k a teszteseteknek megfelel�ek
	    //TODO!! P�lyav�laszt�s most konzolon, ennek is kellene grafikus fel�let!
	    //TODO!! P�lyav�laszt�s f�jlb�l j�jj�n, ne a tesztesetekb�l!
	    	//Protot�pus koncepcti�ja, 8. oldal
